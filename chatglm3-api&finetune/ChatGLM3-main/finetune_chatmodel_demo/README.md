...
本项目用：
```bash
MODEL_PATH="../finetune_chatmodel_demo/output/crazy_literature_with_scene_and_rate-20231212-080910-1e-4/checkpoint-500" TOKENIZER_PATH="../chatglm3-6b" streamlit run main.py
```
